import IconBicycle from "../assets/img/children/bicycle.png";
...
export default function ShoeChildren() {
  ...
  const fetchSliderHome = async () => {
    ...
    const res = await axios.get(
      `http://localhost:1337/api/children?populate=*?${query}`
    );
  ...
  return (
    <div className="shoe-fball mt-[80px] flex justify-between w-[1220px] mx-auto">
      ...
      <div className="shoe-fb-right h-[690px]">
        <div className="shoe-children-right-item ml-[10px] flex items-center ">
          <div className="h-[620px] w-full text-center relative">
            <div className="text-white text-center flex justify-center">
              ...
              <p className="text-[24px] font-bold">THỜI TRANG TRẺ EM </p>
            </div>
            <div className="icon-football flex justify-center mt-[10px]">
              <img src={IconBicycle} alt="" className="w-[50px] h-[50px] " />
            </div>
